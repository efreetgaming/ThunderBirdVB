...
Public Class newlyReports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ThunderBirdHotel.newlyReports.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TotalValue() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachednewlyReports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As newlyReports = New newlyReports()
        rpt.Site = Me.Site
        Return rpt
    End Function
