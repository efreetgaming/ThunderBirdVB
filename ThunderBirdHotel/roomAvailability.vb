...
Public Class roomAvailability
    ...
    Public Sub loadAvailableRoom()
        Dim query As String = "Select * from tbl_rooms WHERE Status = 'Available' OR Status = 'Cleaning' AND Guest_Name IS NULL"
    ...
    Private Sub dgvAvailableRoom_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvAvailableRoom.CellClick
        If e.RowIndex >= 0 Then
            ...
            checkIn.lblMaxGuest.Text = dgvAvailableRoom.Rows(e.RowIndex).Cells(6).Value.ToString
    ...
    Private Sub tmrUpdateShitty_Tick(sender As Object, e As EventArgs) Handles tmrUpdateShitty.Tick
        loadAvailableRoom()
    End Sub

    Private Sub btnConfirmRoom_Click(sender As Object, e As EventArgs) Handles btnConfirmRoom.Click
        Me.Close()
    End Sub
End Class